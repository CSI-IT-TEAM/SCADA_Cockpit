...
namespace FORM
{
    public partial class FORM_SCADA_ENHANCEMENT : Form
    {
        ...
        {
            models.Add(new ChartModel { Title = "1.Rework && Machine Occur", Code = "RW", ChartType = "LINE", NumberOfSeries = 1, AxisLabelColumnName = "SEASON_LABEL", ValueColumnName = "QTY", formCall = "10337", AxisYTitle = "Prs", axisXTitle = "Season", valuePatten = "{V:#,#}" });
        ...
        private void OnButtonDetailClick(ChartModel model, string YearValue)
        {
            try
            {
                ...
                if (model.Code.Equals("PPH"))
                    ComVar.Var._strValue5 = "        PPH Report By Month";

                ComVar.Var._IsBack = true;
                ComVar.Var._strValue1 = YearValue;
                if (model.Code.Equals("MOLD_CHANGE") || model.Code.Equals("MOLD_CYCLE"))
                    ComVar.Var._strValue3 = model.Code;
