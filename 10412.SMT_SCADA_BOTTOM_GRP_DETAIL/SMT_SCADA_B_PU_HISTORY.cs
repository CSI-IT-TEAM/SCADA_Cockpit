...
namespace FORM
{
    public partial class SMT_SCADA_B_PU_HISTORY : Form
    {
        public SMT_SCADA_B_PU_HISTORY()
        {
            InitializeComponent();
        }
        ...
        public void BindingTree(DataTable dt)
        {
           ...
           // treeList.CheckAll();
            ...
            //        foreach (TreeListNode node2 in node.RootNode.Nodes)
            //        {
        ...
        private void GetDataTable()
        {
            ...
            isCheckState = false;
            dt = dtData.Copy();//Giu lai datatable goc, de su dung lai.
